...
export const mobileParityInventory = [
  ...
  {
    assertions: ['TenTap native simulator rendering', 'document-content serialization with desktop highlight, display math, hard-break, and image regression checks'],
